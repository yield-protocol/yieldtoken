...
async function unpause(name, cloneAddress) {
  let log = await dycoFactoryContract.methods.unpause(cloneAddress).send({
...
//unpause('Seed and Private', '0x9279a161cace9c45c07a93c2096133094f22f258');
unpause('Strategic', '0x671d70480548c6b171dcb7dbad3f3b3755ba4770');
